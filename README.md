...
Используется RAID 10 За счёт своей скорости и надежности. Требуется в 2 раза больше места, чем физически требуется. <br/>


  CPU(cores)  | RAM (Gb)      |SSD (Tb)| Network (Mbps)|Количество|
------------- | ------------- |--------|---------------|----------|
16            | 32            |8       |100            |70 +  70 реплик |

 ### Profile
  CPU(cores)  | RAM (Gb)      |SSD (Gb)| Network (Mbps)|Количество|
------------- | ------------- |--------|---------------|----------|
16            | 16            |256     |100            |12 +  12 реплик |
