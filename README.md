...
## Балансировка 
 Нагрузка должна балансироваться на всех уровнях. <br/>
 ...
 На L4 используется метод Virtual Server via IP Tunneling. За счет своей производительности и размещения серверов в разных физических сетях. <br/>
...
L4 - балансирует трафик между множеством серверов.
L7(Ngnix) - балансирует трафик между определенной группой сервисов.
 ...
 ### Просмотр поста
 2. Posts - получение данных к посту
 3. Images - Получение картинки
